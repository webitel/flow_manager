...
func (r *Router) cancelQueue(ctx context.Context, scope *flow.Flow, call model.Call, args any) (model.Response, *model.AppError) {
	return call.Set(ctx, model.Variables{
		"cc_cancel": fmt.Sprintf("%v", call.CancelQueue()),
	})
}

func (r *Router) queue(ctx context.Context, scope *flow.Flow, call model.Call, args any) (model.Response, *model.AppError) {
	var q QueueJoinArg
