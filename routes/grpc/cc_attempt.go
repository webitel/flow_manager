...
func (r *Router) cancel(ctx context.Context, scope *flow.Flow, conn model.GRPCConnection, args any) (model.Response, *model.AppError) {
...
func (r *Router) confirm(ctx context.Context, scope *flow.Flow, conn model.GRPCConnection, args any) (model.Response, *model.AppError) {
...
func (r *Router) success(ctx context.Context, scope *flow.Flow, conn model.GRPCConnection, args any) (model.Response, *model.AppError) {
...
func (r *Router) abandoned(ctx context.Context, scope *flow.Flow, conn model.GRPCConnection, args any) (model.Response, *model.AppError) {
	argv := AfterAttemptAbandoned{
		Status: "abandoned",
	}
...
func (r *Router) retry(ctx context.Context, scope *flow.Flow, conn model.GRPCConnection, args any) (model.Response, *model.AppError) {
	argv := AfterAttemptRetry{}
