...
func (c *contactsClient) SearchContacts(ctx context.Context, in *SearchContactsRequest, opts ...grpc.CallOption) (*ContactList, error) {
	...
	out := new(ContactList)
	err := c.cc.Invoke(ctx, Contacts_SearchContacts_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *contactsClient) SearchContactsNA(ctx context.Context, in *SearchContactsNARequest, opts ...grpc.CallOption) (*ContactList, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ContactList)
	err := c.cc.Invoke(ctx, Contacts_SearchContactsNA_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *contactsClient) LocateContact(ctx context.Context, in *LocateContactRequest, opts ...grpc.CallOption) (*Contact, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Contact)
	err := c.cc.Invoke(ctx, Contacts_LocateContact_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
