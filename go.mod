...
require (
	...
	buf.build/gen/go/webitel/chat/grpc/go v1.3.0-20240603123532-2f30f6c98cb1.3
	buf.build/gen/go/webitel/chat/protocolbuffers/go v1.34.1-20240603123532-2f30f6c98cb1.1
