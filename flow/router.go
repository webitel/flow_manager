...
func NewRouter(fm *app.FlowManager, contacts domaincontacts.Client, engine domainengine.Client, meeting domainmeeting.Client) Router {
	var router = &router{
		fm:       fm,
		contacts: contacts,
		engine:   engine,
