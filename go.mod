...
require (
	buf.build/gen/go/webitel/cases/grpc/go v1.5.1-20250317123025-8c43d740b4a2.2
	buf.build/gen/go/webitel/cases/protocolbuffers/go v1.36.6-20250317123025-8c43d740b4a2.1
